...
export const FieldContent = ({ field, documentMeta }: FieldIconProps) => {
  ...
  if (
    ...
    return (
      <div className="text-field-card-foreground xxs:text-[0.7rem] xs:text-[0.75rem] flex flex-row items-center py-0.5 text-[0.7rem] text-sm sm:text-[0.8rem]">
        <p>Select</p>
  ...
  return (
    <div
      className={cn(
        'text-field-card-foreground xxs:text-[0.7rem] xs:text-[0.75rem] flex h-full w-full max-w-full items-center justify-center gap-x-1.5 overflow-visible whitespace-normal break-words text-center text-[0.7rem] sm:text-[0.8rem]',
        {
          ...
          'font-signature text-[0.8rem]': isSignatureField,
        },
      )}
    >
      {textToDisplay}
